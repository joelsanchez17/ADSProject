...
object opcodeT extends  ChiselEnum {
    val L_type  = Value("b0000011".U(7.W)) // LOAD (I_type)
    val I_type  = Value("b0010011".U(7.W))
    val AU_type = Value("b0010111".U(7.W)) // AUIPC (U_type)
    val S_type  = Value("b0100011".U(7.W))
    val R_type  = Value("b0110011".U(7.W))
    val U_type  = Value("b0110111".U(7.W)) // LUI
    val B_type  = Value("b1100011".U(7.W))
    val JR_type = Value("b1100111".U(7.W)) // JALR (I_type)
    val J_type  = Value("b1101111".U(7.W))
    val unimp   = Value("b1110011".U(7.W)) // Unimplemented (finish of simulation)
}
