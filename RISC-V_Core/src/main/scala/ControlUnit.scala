...
class ControlUnit extends  Module {
    ...
    switch(opcode){
        is(opcodeT.R_type){
            when     ((funct3 === "b000".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isADD}
            .elsewhen((funct3 === "b000".U(3.W)) && (funct7 === "b0100000".U(7.W))) {io.ALUOp := isSUB}
            .elsewhen((funct3 === "b100".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isXOR}
            .elsewhen((funct3 === "b110".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isOR}
            .elsewhen((funct3 === "b111".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isAND}
            .elsewhen((funct3 === "b001".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isSLL}
            .elsewhen((funct3 === "b101".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isSRL}
            .elsewhen((funct3 === "b101".U(3.W)) && (funct7 === "b0100000".U(7.W))) {io.ALUOp := isSRA}
            .elsewhen((funct3 === "b010".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isSLT}
            .elsewhen((funct3 === "b011".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isSLTU}

            .otherwise {io.ALUOp := invalid}
        }
        is(opcodeT.I_type){
            when     (funct3 === "b000".U(3.W)) {io.ALUOp := isADD}  // ADDI
              .elsewhen(funct3 === "b110".U(3.W)) {io.ALUOp := isOR}   // ORI
              .elsewhen((funct3 === "b001".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isSLL} // SLLI
              .elsewhen((funct3 === "b101".U(3.W)) && (funct7 === "b0000000".U(7.W))) {io.ALUOp := isSRL} // SRLI
              .elsewhen((funct3 === "b101".U(3.W)) && (funct7 === "b0100000".U(7.W))) {io.ALUOp := isSRA} // SRAI
              .otherwise {io.ALUOp := invalid}
        }
