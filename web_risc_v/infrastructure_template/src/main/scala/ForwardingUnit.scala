...
class ForwardingUnit extends Module {
    ...
    */
    ...
    rs1_mem_hazard := ((checkRS1 === 1.U) && (io.rs1_id === io.rd_mem) && (io.wrEn_mem === 1.U)  &&  (io.rd_mem =/= 0.U) )
    rs1_wb_hazard := ((checkRS1 === 1.U) && (io.rs1_id === io.rd_wb) && (io.wrEn_wb === 1.U) &&  (io.rd_wb =/= 0.U))
    
    rs2_mem_hazard := ((checkRS2 === 1.U) && (io.rs2_id === io.rd_mem) && (io.wrEn_mem === 1.U) &&  (io.rd_mem =/= 0.U))
    rs2_wb_hazard := ((checkRS2 === 1.U) && (io.rs2_id === io.rd_wb) && (io.wrEn_wb === 1.U) &&  (io.rd_wb =/= 0.U))
