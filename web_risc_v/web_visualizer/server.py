...
async def get_workspace():
    ...
    # 🚨 ONLY these files will be sent to the student (hiding the wrappers)
    editable_scala_files = [
        ...
        "ALU.scala", "HazardDetection.scala" # Included just in case!
    ]

    scala_src_dir = os.path.join(template_dir, "src", "main", "scala")

    # Read the allowed Scala files
